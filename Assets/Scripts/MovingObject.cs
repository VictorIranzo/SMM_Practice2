...
public abstract class MovingObject : MonoBehaviour
{
    ...
    protected IEnumerator SmoothMovement(Vector3 end)
    {
        ...
        while (sqrRemainingDistance > float.Epsilon)
        {
            ...
            // It basically pauses and waits for the next frame and in the next frame it'll go back to perform the while statement again.
            /*
                ...
                If null, then it will run again next frame. Some coroutine may WaitForEndOfFrame if they need to perform action at that specific moment. In some cases, you may start a timer like you did in the second case.
                At that point, the coroutine is off, and the program is able to run the rest of it. On the next frame, Unity will find stacked 
                coroutine and will call them from where they left off. If your loop never reaches a true condition, then you basically created an update method.
